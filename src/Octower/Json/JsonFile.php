...
use Octower\Downloader\TransportException;
...
class JsonFile
{
    ...
    /**
     * Validates the schema of the current json file according to octower-schema.json rules
     *
    ...
    public function validateSchema($schema = self::STRICT_SCHEMA)
    {
        ...
        $schemaFile = __DIR__ . '/../../../res/octower-schema.json';
